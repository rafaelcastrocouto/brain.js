...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var o=t[r];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(e,o.key,o)}}return function(t,r,o){return r&&e(t.prototype,r),o&&e(t,o),t}}(),_neuralNetwork=require("./neural-network"),_neuralNetwork2=_interopRequireDefault(_neuralNetwork),_convolution=require("./utilities/convolution"),_convolution2=_interopRequireDefault(_convolution),_pool=require("./utilities/pool"),_pool2=_interopRequireDefault(_pool),_relu=require("./utilities/relu"),_relu2=_interopRequireDefault(_relu),CNN=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).apply(this,arguments))}return _inherits(t,e),_createClass(t,[{key:"runInput",value:function(e){throw new Error("not yet implemented")}},{key:"buildBackPropagateKernel",value:function(){}},{key:"runBody",get:function(){for(var e=["this.outputs[0] = input","var output = null","var inputs = []"],t=1;t<=this.outputLayer;t++){for(var r=0;r<this.sizes[t];r++){var o=new _convolution2.default;e.push(o.runBody);var u=new _pool2.default;e.push(u.runBody);var n=new _relu2.default;e.push(n.runBody),e.push("this.outputs["+t+"]["+r+"] = output")}e.push("output = input = this.outputs["+t+"]")}return output}}]),t}(_neuralNetwork2.default);exports.default=CNN,console.log((new CNN).runBody);
...
"use strict";function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}function _taggedTemplateLiteral(t,e){return Object.freeze(Object.defineProperties(t,{raw:{value:Object.freeze(e)}}))}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var i=0;i<e.length;i++){var n=e[i];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}return function(e,i,n){return i&&t(e.prototype,i),n&&t(e,n),e}}(),_templateObject=_taggedTemplateLiteral(["outputDeltas[","] = 0"],["outputDeltas[","] = 0"]),Convolution=function(){function t(e){_classCallCheck(this,t),Object.assign(this,t.defaults,e),this.runKernel=null,this.runBackpropagateKernel=null,this.filters=[],this.filterDeltas=[],this.biasDeltas=[],this.biases=[],this.inputDeltas=[],this.outputs=[],null===this.height&&(this.height=this.width),this.outWidth=Math.floor((this.width+2*this.padding-this.width)/this.stride+1),this.outHeight=Math.floor((this.height+2*this.padding-this.height)/this.stride+1);for(var i=0;i<this.depth;i++)this.filters.push(new Float32Array3D(this.width,this.height,this.depth)),this.filterDeltas.push(new Float32Array3D(this.width,this.height,this.depth));this.build()}return _createClass(t,[{key:"build",value:function(){this.buildRunKernel(),this.buildRunBackpropagateKernel()}},{key:"buildRunKernel",value:function(){this.runKernel=new Function("convolutionFilters","convolutionInputs","convolutionOutputs","convolutionBiases",this.runBody)}},{key:"run",value:function(t){return this.runKernel(this.filters,t,this.outputs,this.biases),this.outputs}},{key:"buildRunBackpropagateKernel",value:function(){this.runBackpropagateKernel=new Function("convolutionFilters","convolutionFilterDeltas","convolutionInputs","convolutionInputDeltas","convolutionBiasDeltas","convolutionChainGradients",this.runBackPropagateBody)}},{key:"runBackpropagate",value:function(t){this.runBackpropagateKernel(this.filters,this.filterDeltas,t,this.inputDeltas,this.biasDeltas)}},{key:"iterate",value:function(t){for(var e=this.width,i=(this.height,this.outWidth),n=this.outHeight,o=this.depth,r=this.stride,s=this.padding,a=t.eachFilter,u=t.beforeConvolve,h=t.eachConvolve,l=t.afterConvolve,c=0;c<o;c++){a(c);for(var p=this.filters[c],f=-s,v=0;v<n;f+=r,v++)for(var d=-s,g=0;g<i;d+=r,g++){var b=e*v+d*o+c;u(b,v,g,c);for(var y=0;y<p.height;y++)for(var C=f+y,w=0;w<p.width;w++){var _=d+w;if(!(C<0&&C>=p.height&&_<0&&_>=e))for(var D=0;D<p.depth;D++)h((p.width*y+w)*p.depth+D,(e*C+_)*p.depth+D)}l(b,g,v,c)}}}},{key:"runBody",get:function(){var t=this,e=["var weights","var filterWeights"];return this.iterate({eachFilter:function(t){e.push("filterWeights = filters["+t+"]")},beforeConvolve:function(t,i,n,o){e.push("weight = 0")},eachConvolve:function(i,n){t.inputDeltas[n]=0,e.push("weight += filterWeights["+i+"] * inputs["+n+"]","inputDeltas["+n+"] = 0")},afterConvolve:function(i,n,o,r){t.biases[r]=0,t.outputs[i]=0,e.push("weight += biases["+r+"]",("outputs["+i+"] = weight")(_templateObject,i))}}),e.join(";\n  ")+";"}},{key:"runBackPropagateBody",get:function(){var t=this,e=["var convolutionChainGradient","var convolutionFilterWeights"];return this.iterate({eachFilter:function(t){e.push("convolutionFilterWeights = convolutionFilters["+t+"]")},beforeConvolve:function(t,i,n,o){e.push("convolutionChainGradient = convolutionChainGradients["+t+"]")},eachConvolve:function(t,i){e.push("convolutionFilterDeltas["+t+"] += convolutionInputs["+i+"] * convolutionChainGradient","convolutionInputDeltas["+i+"] += convolutionFilterWeights["+t+"] * convolutionChainGradient")},afterConvolve:function(i,n,o,r){t.biasDeltas[r]=0,e.push("convolutionBiasDeltas["+r+"] += convolutionChainGradient")}}),e.join(";\n  ")+";"}}]),t}();exports.default=Convolution,Convolution.defaults={width:9,height:null,inWidth:9,inHeight:9,depth:3,stride:3,padding:0};var Float32Array3D=function(t){function e(t,i,n){_classCallCheck(this,e);var o=_possibleConstructorReturn(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t*i*n));return o.width=t,o.height=i,o.depth=n,o}return _inherits(e,t),e}(Float32Array);
...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var i=0;i<e.length;i++){var u=e[i];u.enumerable=u.enumerable||!1,u.configurable=!0,"value"in u&&(u.writable=!0),Object.defineProperty(t,u.key,u)}}return function(e,i,u){return i&&t(e.prototype,i),u&&t(e,u),e}}(),_zeros=require("./zeros"),_zeros2=_interopRequireDefault(_zeros),Pool=function(){function t(e){_classCallCheck(this,t),Object.assign(this,t.defaults,e),null===this.height&&(this.height=this.width),this.outWidth=Math.floor((this.inWidth+2*this.padding-this.width)/this.stride+1),this.outHeight=Math.floor((this.inHeight+2*this.padding-this.height)/this.stride+1),this.switchX=(0,_zeros2.default)(this.outWidth*this.outHeight*this.depth),this.switchY=(0,_zeros2.default)(this.outWidth*this.outHeight*this.depth),this.runKernel=null,this.runBackpropagateKernel=null,this.inputs=(0,_zeros2.default)(this.width*this.height),this.inputDeltas=(0,_zeros2.default)(this.width*this.height),this.outputs=(0,_zeros2.default)(this.outWidth*this.outHeight),this.outputDeltas=(0,_zeros2.default)(this.outWidth*this.outHeight),this.build()}return _createClass(t,[{key:"build",value:function(){this.buildRunKernel(),this.buildRunBackpropagateKernel()}},{key:"buildRunKernel",value:function(){this.runKernel=new Function(this.runInputs(),this.runBody)}},{key:"runInputs",value:function(){return["reluInputs","reluOutputs","switchX","switchY"]}},{key:"run",value:function(){return this.runKernel(this.inputs,this.outputs,this.switchX,this.switchY),this.outputs}},{key:"buildRunBackpropagateKernel",value:function(){this.runKernel=new Function(this.runBackpropagateInputs(),this.runBackpropagateBody)}},{key:"runBackpropagateInputs",value:function(){return["inputs","outputs","switchX","switchY"]}},{key:"runBackpropagate",value:function(){this.runBackpropagateKernel(this.inputs,this.outputs,this.switchX,this.switchY)}},{key:"iterate",value:function(t){for(var e=this.padding,i=this.depth,u=this.width,n=this.outWidth,s=this.height,h=this.outHeight,r=this.stride,o=t.beforePool,a=t.eachPool,l=t.afterPool,c=0;c<i;c++)for(var p=-e,d=0;d<n;p+=r,d++)for(var f=-e,w=0;w<h;f+=r,w++){o(d*w*c);for(var g=0;g<u;g++)for(var v=0;v<s;v++){var k=f+v,y=p+g;k<0&&k>=s&&y<0&&y>=u||a(y*k*c,c)}l(d*w*c)}}},{key:"runBody",get:function(){var t=["var switchIndex = 0"];return this.iterate({beforePool:function(e){t.push("var reluOutput = -99999","var winX = -1","var winY = -1")},eachPool:function(e){t.push("var reluInput = reluInputs["+e+"]","if (reluInput > reluOutput) {","reluOutput = reluInput","winX = innerX","winY = innerY","}")},afterPool:function(e){t.push("switchX[switchIndex] = winX","switchY[switchIndex] = winY","reluOutputs["+e+"] = reluOutput","reluOutputDeltas["+e+"] = 0","switchIndex++")}}),t.join(";\n  ")+";"}},{key:"runBackpropagateBody",get:function(){var t=this,e=["var switchIndex = 0"];return this.iterate({beforePool:function(i){e.push("var outputDeltaXY = (("+t.width+" * switchY[switchIndex]) + switchX[switchIndex]) * "+t.depth)},eachPool:function(t,i){e.push("outputDeltas[outputDeltaXY + "+i+"] = outputs["+t+"]","switchIndex++")},afterPool:function(t){}}),e.join(";\n  ")+";"}}]),t}();exports.default=Pool,Pool.defaults={width:9,height:null,inWidth:9,inHeight:9,depth:3,stride:2,padding:0};
...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var u=0;u<e.length;u++){var n=e[u];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}return function(e,u,n){return u&&t(e.prototype,u),n&&t(e,n),e}}(),_zeros=require("./zeros"),_zeros2=_interopRequireDefault(_zeros),Relu=function(){function t(e,u){_classCallCheck(this,t),this.runKernel=null,this.runBackpropagateKernel=null,this.inputs=(0,_zeros2.default)(this.width*this.height),this.outputs=(0,_zeros2.default)(this.width*this.height),this.inputDeltas=new Array(e.length),this.outputDeltas=new Array(u.length),this.build()}return _createClass(t,[{key:"build",value:function(){this.buildRunKernel(),this.buildRunBackpropagateKernel()}},{key:"buildRunKernel",value:function(){this.runKernel=new Function(this.runInputs,this.runBody)}},{key:"run",value:function(){this.runKernel(this.input,this.inputDeltas,this.output,this.outputDeltas)}},{key:"buildRunBackpropagateKernel",value:function(){this.runBackpropagateKernel=new Function(this.runBackpropagateInputs,this.runBackpropagateBody)}},{key:"runBackpropagate",value:function(){this.runBackpropagateKernel(this.input,this.inputDeltas,this.output,this.outputDeltas)}},{key:"iterate",value:function(t){for(var e=this.input,u=0;u<e.length;u++)t.each(u)}},{key:"runBody",get:function(){var t=[];return this.iterate({each:function(e){t.push("outputs["+e+"] = inputs["+e+"] < 0 ? 0 : inputs["+e+"]","inputDeltas["+e+"] = 0","outputDeltas["+e+"] = 0")}}),t.join(";\n  ")+";"}},{key:"runBackpropagateBody",get:function(){var t=[];return this.iterate({each:function(e){t.push("inputDeltas["+e+"] = output["+e+"] <= 0 ? 0 : outputDeltas["+e+"]")}}),t.join(";\n  ")+";"}}]),t}();exports.default=Relu,Relu.runInputs=["inputs","inputDeltas","outputs","outputDeltas"],Relu.runBackpropagateInputs=["inputs","inputDeltas","outputs","outputDeltas"];
...
var crossValidate=require("./dist/cross-validate").default,likely=require("./dist/likely").default,lookup=require("./dist/lookup").default,NeuralNetwork=require("./dist/neural-network").default,CNN=require("./dist/cnn").default,TrainStream=require("./dist/train-stream").default,RNN=require("./dist/recurrent/rnn").default,LSTM=require("./dist/recurrent/lstm").default,GRU=require("./dist/recurrent/gru").default,utilities={max:require("./dist/utilities/max").default,mse:require("./dist/utilities/mse").default,ones:require("./dist/utilities/ones").default,random:require("./dist/utilities/random").default,randomWeight:require("./dist/utilities/random-weight").default,randos:require("./dist/utilities/randos").default,range:require("./dist/utilities/range").default,toArray:require("./dist/utilities/to-array").default,DataFormatter:require("./dist/utilities/data-formatter").default,zeros:require("./dist/utilities/zeros").default},brain={crossValidate:crossValidate,likely:likely,lookup:lookup,NeuralNetwork:NeuralNetwork,CNN:CNN,TrainStream:TrainStream,recurrent:{RNN:RNN,LSTM:LSTM,GRU:GRU},utilities:utilities};"undefined"!=typeof window?window.brain=brain:module.exports=brain;
...
},{"./_stream_duplex":61,"./internal/streams/BufferList":66,"_process":59,"buffer":51,"buffer-shims":50,"core-util-is":52,"events":53,"inherits":55,"isarray":57,"process-nextick-args":58,"stream":71,"string_decoder/":72,"util":49}],64:[function(require,module,exports){
...
},{"./_stream_duplex":61,"_process":59,"buffer":51,"buffer-shims":50,"core-util-is":52,"events":53,"inherits":55,"process-nextick-args":58,"stream":71,"util-deprecate":73}],66:[function(require,module,exports){
...
},{"./lib/_stream_duplex.js":61,"./lib/_stream_passthrough.js":62,"./lib/_stream_readable.js":63,"./lib/_stream_transform.js":64,"./lib/_stream_writable.js":65,"_process":59,"stream":71}],69:[function(require,module,exports){
