...
"use strict";function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var i=0;i<e.length;i++){var n=e[i];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}return function(e,i,n){return i&&t(e.prototype,i),n&&t(e,n),e}}(),Convolution=function(){function t(e){_classCallCheck(this,t),Object.assign(this,t.defaults,e),this.runKernel=null,this.runBackpropagateKernel=null,this.filters=[],this.filterDeltas=[],this.biasDeltas=[],this.biases=[],this.inputDeltas=[],this.outputs=[],null===this.height&&(this.height=this.width),this.outWidth=Math.floor((this.width+2*this.padding-this.width)/this.stride+1),this.outHeight=Math.floor((this.height+2*this.padding-this.height)/this.stride+1);for(var i=0;i<this.depth;i++)this.filters.push(new Float32Array3D(this.width,this.height,this.depth)),this.filterDeltas.push(new Float32Array3D(this.width,this.height,this.depth));this.build()}return _createClass(t,null,[{key:"defaults",get:function(){return{width:9,height:null,inWidth:9,inHeight:9,depth:3,stride:3,padding:0}}}]),_createClass(t,[{key:"build",value:function(){this.buildRunKernel(),this.buildRunBackpropagateKernel()}},{key:"buildRunKernel",value:function(){var t=this,e=["var weights, filterWeights"];this.iterateStructure({eachFilter:function(t){e.push("filterWeights = filters["+t+"]")},beforeConvolve:function(t,i,n,r){e.push("weight = 0")},eachConvolve:function(i,n){t.inputDeltas[n]=0,e.push("weight += filterWeights["+i+"] * inputs["+n+"]","inputDeltas["+n+"] = 0")},afterConvolve:function(i,n,r,s){t.biases[s]=0,t.outputs[i]=0,e.push("weight += biases["+s+"]","outputs["+i+"] = weight")}}),this.runKernel=new Function("filters","inputs","outputs","biases",e.join(";\n  ")+";")}},{key:"run",value:function(t){return this.runKernel(this.filters,t,this.outputs,this.biases),this.outputs}},{key:"buildRunBackpropagateKernel",value:function(){var t=this,e=["var chainGrad, filterWeights"];this.iterateStructure({eachFilter:function(t){e.push("filterWeights = filters["+t+"]")},beforeConvolve:function(t,i,n,r){e.push("chainGrad = chainGrads["+t+"]")},eachConvolve:function(t,i){e.push("filterDeltas["+t+"] += inputs["+i+"] * chainGrad","inputDeltas["+i+"] += filterWeights["+t+"] * chainGrad")},afterConvolve:function(i,n,r,s){t.biasDeltas[s]=0,e.push("biasDeltas["+s+"] += chainGrad")}}),this.runBackpropagateKernel=new Function("filters","filterDeltas","inputs","inputDeltas","biasDeltas","chainGrads",e.join(";\n  ")+";")}},{key:"runBackpropagate",value:function(t){this.runBackpropagateKernel(this.filters,this.filterDeltas,t,this.inputDeltas,this.biasDeltas)}},{key:"iterateStructure",value:function(t){for(var e=this.width,i=(this.height,this.outWidth),n=this.outHeight,r=this.depth,s=this.stride,h=this.padding,a=t.eachFilter,o=t.beforeConvolve,u=t.eachConvolve,l=t.afterConvolve,c=0;c<r;c++){a(c);for(var f=this.filters[c],p=-h,d=0;d<n;p+=s,d++)for(var v=-h,g=0;g<i;v+=s,g++){var b=e*d+v*r+c;o(b,d,g,c);for(var w=0;w<f.height;w++)for(var y=p+w,C=0;C<f.width;C++){var _=v+C;if(y>=0&&y<f.height&&_>=0&&_<e)for(var D=0;D<f.depth;D++)u((f.width*w+C)*f.depth+D,(e*y+_)*f.depth+D)}l(b,g,d,c)}}}}]),t}();exports.default=Convolution;var Float32Array3D=function(t){function e(t,i,n){_classCallCheck(this,e);var r=_possibleConstructorReturn(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t*i*n));return r.width=t,r.height=i,r.depth=n,r}return _inherits(e,t),e}(Float32Array),c=new Convolution;c.build(),console.log(c.runKernel.toString());
...
},{"./_stream_duplex":59,"./internal/streams/BufferList":64,"_process":57,"buffer":49,"buffer-shims":48,"core-util-is":50,"events":51,"inherits":53,"isarray":55,"process-nextick-args":56,"stream":69,"string_decoder/":70,"util":47}],62:[function(require,module,exports){
...
},{"./_stream_duplex":59,"_process":57,"buffer":49,"buffer-shims":48,"core-util-is":50,"events":51,"inherits":53,"process-nextick-args":56,"stream":69,"util-deprecate":71}],64:[function(require,module,exports){
...
},{"./lib/_stream_duplex.js":59,"./lib/_stream_passthrough.js":60,"./lib/_stream_readable.js":61,"./lib/_stream_transform.js":62,"./lib/_stream_writable.js":63,"_process":57,"stream":69}],67:[function(require,module,exports){
